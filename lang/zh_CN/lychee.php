...
return [
	...
	'UPDATE' => 'Update',
	'RESET' => 'Reset',
	'DISABLE_TOKEN_TOOLTIP' => '禁用',
	'ENABLE_TOKEN' => '启用 API token',
	'DISABLED_TOKEN_STATUS_MSG' => '已禁用',
	'TOKEN_BUTTON' => 'API Token ...',
	'TOKEN_NOT_AVAILABLE' => '你已经看过了这个token',
	'TOKEN_WAIT' => '请等待 ...',
	...
	'SHARING_ALBUM_USERS' => '与用户共享此相册',
	'WAIT_FETCH_DATA' => '正在获取数据，请稍候 …',
	'SHARING_ALBUM_USERS_NO_USERS' => '没有可与之共享相册的用户',
	'SHARING_ALBUM_USERS_LONG_MESSAGE' => '选择要与之共享此相册的用户',

	'DELETE_ALBUM_QUESTION' => '删除相册和照片',
	'KEEP_ALBUM' => '保留相册',
	'DELETE_ALBUM_CONFIRMATION' => '是否确认删除相册《%s》以及相册中包含的所有照片？操作后不可恢复！',

	'DELETE_TAG_ALBUM_QUESTION' => '删除相册',
	'DELETE_TAG_ALBUM_CONFIRMATION' => '是否确认删除相册《%s》以及相册中包含的所有照片？操作后不可恢复！',
	...
	'SET_HEADER' => '设置为相册页眉',
	'REMOVE_HEADER' => '取消设置为相册页眉',
	'SET_COMPACT_HEADER' => '使用紧凑型页眉',
	...
	'ALBUM_SHR_NO' => '否',
	'ALBUM_PUBLIC' => '公开',
	'ALBUM_PUBLIC_EXPL' => '匿名用户可以访问此相册，但须遵守以下限制',
	'ALBUM_FULL' => '原始图像',
	'ALBUM_FULL_EXPL' => '匿名用户可以查看全分辨率照片',
	'ALBUM_HIDDEN' => '隐藏',
	'ALBUM_HIDDEN_EXPL' => '匿名用户需要直接链接才能访问此相册',
	'ALBUM_MARK_NSFW' => '将相册标记为敏感内容',
	'ALBUM_UNMARK_NSFW' => '取消相册的敏感内容标记',
	'ALBUM_NSFW' => '敏感内容',
	'ALBUM_NSFW_EXPL' => '相册被标记为包含敏感内容。',
	'ALBUM_DOWNLOADABLE' => '可下载',
	'ALBUM_DOWNLOADABLE_EXPL' => '匿名用户可以下载此相册',
	'ALBUM_SHARE_BUTTON_VISIBLE' => '分享按钮可见',
	'ALBUM_SHARE_BUTTON_VISIBLE_EXPL' => '匿名用户看到社交媒体共享链接',
	'ALBUM_PASSWORD' => '密码',
	'ALBUM_PASSWORD_PROT' => '受到密码保护',
	'ALBUM_PASSWORD_PROT_EXPL' => '匿名用户需要共享密码才能访问此相册',
	...
	'ALBUM_ORDERING' => '排序依据',
	'ALBUM_PHOTO_ORDERING' => '照片排序方式',
	'ALBUM_CHILDREN_ORDERING' => '相册排序方式',
	'ALBUM_OWNER' => 'Owner',
	...
	'PHOTO_PUBLIC' => '公开',
	'PHOTO_PUBLIC_EXPL' => '匿名用户可以查看此照片，但须遵守以下限制',
	'PHOTO_FULL' => '原始图像',
	'PHOTO_FULL_EXPL' => '匿名用户可以看到全分辨率照片',
	'PHOTO_HIDDEN' => '隐藏',
	'PHOTO_HIDDEN_EXPL' => '匿名用户需要直接链接才能查看此照片',
	'PHOTO_DOWNLOADABLE' => '可下载',
	'PHOTO_DOWNLOADABLE_EXPL' => '匿名用户可以下载此照片.',
	'PHOTO_SHARE_BUTTON_VISIBLE' => '分享按钮可见',
	'PHOTO_SHARE_BUTTON_VISIBLE_EXPL' => '匿名用户可以看到社交媒体共享链接',
	'PHOTO_PASSWORD_PROT' => '受到密码保护',
	'PHOTO_PASSWORD_PROT_EXPL' => '匿名用户需要共享密码才能查看此照片',
	...
	'PHOTO_NEW_CREATED_AT' => '输入这张图片的上传日期 mm/dd/yyyy, hh:mm [am/pm]',
	'PHOTO_SET_CREATED_AT' => '设置上传日期',
	...
	'RETRY' => '重试',
	'OVERRIDE' => '覆盖',
	'TAGS_OVERRIDE_INFO' => '如果未选中此选项，则新标签将添加到照片的现有标签中。',
	...
	'SETTINGS_SUCCESS_CSS' => '样式表已更新',
	'SETTINGS_SUCCESS_JS' => 'JS 已更新',
	'SETTINGS_SUCCESS_UPDATE' => '设置更新成功',
	'SETTINGS_DROPBOX_KEY' => 'Dropbox API Key',
	'SETTINGS_ADVANCED_WARNING_EXPL' => '更改这些高级设置可能会损害此应用程序的稳定性、安全性和性能。只有当你确定自己在做什么时，你才应该修改它们。',
	'SETTINGS_ADVANCED_SAVE' => '保存我的修改，我接受风险！',
	...
	'NEW_PHOTOS_NOTIFICATION' => '发送新照片通知电子邮件',
	'SETTINGS_SUCCESS_NEW_PHOTOS_NOTIFICATION' => '新照片通知设置已更新',
	'USER_EMAIL_INSTRUCTION' => '添加你的电子邮件，以便使用邮件接收通知。要停止接收电子邮件，只需在下面删除你的电子邮件。',
	...
	'SETTING_RECENT_PUBLIC_TEXT' => '允许匿名用户访问“最近”智能相册',
	'SETTING_STARRED_PUBLIC_TEXT' => '允许匿名用户访问“星标”智能相册',
	'SETTING_ONTHISDAY_PUBLIC_TEXT' => '允许匿名用户访问“今天”智能相册',
	...
	'OVERLAY_DATE' => '照片拍摄日期',
	'ALBUM_DECORATION' => '相册风格:',
	'ALBUM_DECORATION_NONE' => '无',
	'ALBUM_DECORATION_ORIGINAL' => '子相册标记',
	'ALBUM_DECORATION_ALBUM' => '子相册数量',
	'ALBUM_DECORATION_PHOTO' => '图片数量',
	'ALBUM_DECORATION_ALL' => '子相册和图片的数量',
	...
	'NSFW_BANNER' => '<h1>高敏感内容</h1><p>这本相册包含敏感内容，可能会使人反感或不安。</p><p>点击表示我已知晓并继续浏览。</p>',
	'NSFW_HEADER' => '高敏感内容',
	'NSFW_EXPLANATION' => '这本相册包含部分敏感内容，可能会使人反感或不安。',
	'TAP_CONSENT' => '点击表示我已知晓并继续浏览。',
	...
	'UPLOAD_UPDATED' => '更新完成',
	'UPLOAD_GENERAL' => '概述',
	'UPLOAD_IMPORT_SKIPPED_DUPLICATE' => '此照片已被跳过，因为它已在您的库中。',
	'UPLOAD_IMPORT_RESYNCED_DUPLICATE' => '此照片已被跳过，因为它已在您的库中，但其元数据已更新。',
	...
	'UPLOAD_IMPORT_SERVER_INSTR' => '导入位于具有绝对路径的文件夹中的所有照片、文件夹和子文件夹（在服务器上）。路径以空格分隔，请使用\\转义路径中的空格。',
	'UPLOAD_ABSOLUTE_PATH' => '目录的绝对路径。使用空格分隔。',
	'UPLOAD_IMPORT_SERVER_EMPT' => '无法导入空文件夹！',
	'UPLOAD_IMPORT_DELETE_ORIGINALS' => '删除原始图像',
	'UPLOAD_IMPORT_DELETE_ORIGINALS_EXPL' => '原始图像将在导入后尝试删除。',
	'UPLOAD_IMPORT_VIA_SYMLINK' => '符号链接',
	'UPLOAD_IMPORT_VIA_SYMLINK_EXPL' => '使用指向原始文件的符号链接导入文件。',
	'UPLOAD_IMPORT_SKIP_DUPLICATES' => '跳过重复项',
	'UPLOAD_IMPORT_SKIP_DUPLICATES_EXPL' => '跳过现有媒体文件。',
	'UPLOAD_IMPORT_RESYNC_METADATA' => '重新同步元数据',
	'UPLOAD_IMPORT_RESYNC_METADATA_EXPL' => '更新现有媒体文件的元数据。',
	...
	'ERROR_GPX' => '载入GPX文件出错: ',
	'ERROR_EITHER_ALBUMS_OR_PHOTOS' => '请选择相册或照片！',
	'ERROR_COULD_NOT_FIND' => '找不到你想要的东西',
	'ERROR_INVALID_EMAIL' => '不是一个合法的邮箱地址',
	'EMAIL_SUCCESS' => '邮箱已更新',
	'ERROR_PHOTO_NOT_FOUND' => '错误: 照片 %s 找不到！',
	'ERROR_EMPTY_USERNAME' => '新用户名不能为空',
	'ERROR_PASSWORD_DOES_NOT_MATCH' => '新密码不匹配',
	'ERROR_EMPTY_PASSWORD' => '新密码不能为空',
	'ERROR_SELECT_ALBUM' => '选择要共享的相册！',
	'ERROR_SELECT_USER' => '选择要与之共享的用户！',
	'ERROR_SELECT_SHARING' => '选择要删除的共享！',
	'SHARING_SUCCESS' => '分享已更新！',
	'SHARING_REMOVED' => '共享已删除！',
	'USER_CREATED' => '用户已创建',
	'USER_DELETED' => '用户已删除',
	'USER_UPDATED' => '用户已更新',
	'ENTER_EMAIL' => '输入你的邮箱地址：',
	'ERROR_ALBUM_JSON_NOT_FOUND' => '错误：找不到相册json！',
	'ERROR_ALBUM_NOT_FOUND' => '错误：找不到相册 %s',
	'ERROR_DROPBOX_KEY' => '错误：未设置Dropbox密钥',
	'ERROR_SESSION' => '会话已过期',
	'CAMERA_DATE' => '相机日期',
	'NEW_PASSWORD' => '新密码',
	'ALLOW_UPLOADS' => '允许上传',
	'ALLOW_USER_SELF_EDIT' => '允许用户帐户的自我管理',
	'OSM_CONTRIBUTORS' => 'OpenStreetMap贡献者',
];
